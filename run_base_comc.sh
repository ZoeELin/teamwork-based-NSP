...
do
  ...
  python3 Simulate_coop.py "${output_dir}/${scenario}" "${output_dir}/${scenario}-Solutions-ComC${comc_weight}-${i}" "${i}" --comc "$comc_weight"> "logs/${scenario}/simulator-${i}th-coop.txt"
